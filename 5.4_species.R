# #===============================================================================
#
# Section 5.4: Differences in sap yield and sugar content between maple species
#
...
mod5.4.2 <- brms::brm(brms::bf(sap_brix | trunc(lb = 0) ~
                                 ...
                                 (1 | spp) + 
                                 (1 | site / tree)),
                      data = data5.4 %>% filter(!is.na(sap_brix)), # exclude NAs 
                      family = gaussian(), 
...
# additional posterior distribution checks -------------------------------------
pp_check(mod5.4.2, ndraws = 100)
pp_check(mod5.4.2, type = "error_hist",  ndraws = 10)
pp_check(mod5.4.2, type = "scatter_avg", ndraws = 100)
# Error in the posterior distribution looks normally-distributed 

# get model summary and coefficients -------------------------------------------
summary(mod5.4.2)
ranef(mod5.4.2)$spp [, , "Intercept"]
